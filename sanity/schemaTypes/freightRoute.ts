...
export const freightRoute = defineType({
  ...
  title: "Ruta de flete",
  type: "document",
  description: "Rutas fijas de flete desde Guadalajara, con precio pactado por tipo de caja. Se muestran como tarjetas en /flete (el precio nunca se ve en la tarjeta, solo tras cotizar).",
  fields: [
    ...
    defineField({ name: "activo", title: "Activa", type: "boolean", initialValue: true, description: "Desactívala para ocultarla de /flete sin borrarla." }),
  ],
